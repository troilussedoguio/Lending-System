	...
	<div class="content-container">
        ...
        <div class="content-bottom">
			<div class="content-title">
				<h5 class="mb-3">Add New Collector</h5>
                <small aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="collector">Collector</a></li>
                        ...
                        <form class="add_new_user" method="POST" enctype="multipart/form-data">
                            <div class="row mx-0 row-gap-4">
                                <div class="col-12 pt-4">
                                    <strong class="text-secondary">Collector Form Information</strong>
                                    <hr>
                                </div>
                                <input type="hidden" name="csrf_token" value="<?= $_SESSION['csrf_token']; ?>" >
                                <input type="hidden" name="role" class="role" value="2">
                                ...
                                <div class="col-12 col-lg-6">
                                    <div class="form-floating">
                                        <input type="password" name="password" class="form-control" id="password" placeholder="input here">
