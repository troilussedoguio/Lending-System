<!-- add agent modal -->
<div class="modal fade" id="add-agent" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" >
  	<div class="modal-dialog">
    	<div class="modal-content border-0 shadow">
      		<div class="modal-body">
    	        ...
    	        <form id="add-agent-form" method="POST" class="row row-gap-3 mx-0 p-4">
                    <input type="hidden" name="lending_agent_id" id="lending_agent_id" class=" form-control rounded-1" placeholder="enter here">

                    <div class="col-11 col-lg-12 px-0">
                        <div class="form-floating px-0">
                            <input type="text" name="l_agent_name" id="l_agent_name" class=" form-control rounded-1" placeholder="enter here">
                            <label class="form-label" for="l_agent_name">Agent Name</label>
                        </div>
                    </div>  
                    <div class="col-11 col-lg-12 px-0">
                        <div class="form-floating px-0">
