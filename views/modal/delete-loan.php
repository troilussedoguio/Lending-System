...
<div class="modal fade" id="delete-loan-modal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" >
            ...
            <form id="delete-loan-form" method="POST">
                <div class="modal-body">
                    <div class="row row-gap-3 mx-0">
                        <input type="hidden" name="loan_id" id="loan_id" class=" form-control rounded-1" placeholder="enter here">
